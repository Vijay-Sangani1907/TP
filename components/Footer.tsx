      ...
      <div className="container" style={{ 
        ...
        <div style={{ flex: '1 1 250px' }}>
            ...
            <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
                ...
                <a href="mailto:ieeetechithon@atharvauniversity.org" style={{ color: '#ccc', textDecoration: 'none' }}>ieeetechithon@atharvauniversity.org</a>
            </div>
        </div>
